...
<template>
  ...
  <div v-else-if="provider !== undefined" class="card-header">
    ...
    <ul class="list-group list-group-flush">
      <li v-if="provider.phone" class="list-group-item list-group-item-action">
        <!-- telephone -->
        <svg
      ...
      <li v-if="provider.fax" class="list-group-item list-group-item-action">
        <!-- printer -->
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
      ...
      <li v-if="provider.email" class="list-group-item list-group-item-action">
        <!-- envelope -->
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
      ...
      >
        ...
        <a :href="provider.website" target="_blank">Customer Service Website</a>
      </li>
    </ul>
